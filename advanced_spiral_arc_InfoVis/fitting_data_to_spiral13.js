...
function draw_textbox(data, adjacent_nodes, activeNode, count, deg, bet, clo, eig, node_name){
  ...
  var svg = d3.select("#community_textbox")
      .html("<b>Author: </b>"+ node_name +"<br/>" +"<b> Collaborator_Count: </b>"+ deg +"<br/>" +"<br/>" + "<b>Group Information:</b> "+ "<br/>" + "<b>Number of Authors in Group:</b> "+ data.length + "<br/>" + "<b>Edge-density in Group:</b> "+ data[0].density +"<br/>" +"<br/>" +
       ...
       "<b>List of Collaborators:</b> " + adjacent_nodes)
  ...
  let centerX = 150,
    ...
    // Convert rotation to radians.
     ...
     for (i=0; i<no_of_points_in_community;i++){
         ...
         around = (i+30) * aroundRadians + rotation;
...
newdata1=[]
  ...
  for (i=0; i<no_of_points_in_community;i++){
      ...
      around = (i+5) * aroundRadians + rotation;
  ...
  var newElements = node.enter()
                  ...
                  .on("mouseover", function(event,d) {
                                      ...
                                      if (flag_most_connected_nodes){
                                        ...
                                        div.html("<b>Author:</b> "+ d.name +"<br/>" +"<b>Group:</b> " +d.community+ "<br/>"+"<b>Total Collaborators:</b> "+ d.centrality )
                                        .style("left", (event.pageX) + "px")
                                        .style("top", (event.pageY - 28) + "px")
